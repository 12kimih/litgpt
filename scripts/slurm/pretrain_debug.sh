#!/bin/bash
#SBATCH --job-name=debug                   # Name of the job, used in job scheduling and output filenames
...
#SBATCH --ntasks-per-node=48               # Number of tasks to run per node
...
# Run scripts
srun litgpt pretrain --config config_hub/pretrain/debug.yaml
